...
if st.button("Start Fine-Tuning") and uploaded_csv is not None:
    ...
    try:
        ...
        # Retrieve Adapter Name and ID after fine-tuning
        adapter_name = adapter.repo  # Adapter repository name
        adapter_id = adapter.id  # Adapter ID generated by Predibase
